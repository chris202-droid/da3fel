			...
			<div class="collapse navbar-collapse" id="navbarSupportContent">
				<center>
					<ul class="nav justify-content-end nav-tabs">
				      ...
				      <li class="nav-item  menu_nav"> <a class="nav-link" href="index.php?page=cours.php" style=" color: white;"> Cours</a> </li>

				      <li class="nav-item  menu_nav"> <a class="nav-link" href="index.php?page=inscription.php" style=" color: white;"> Inscription</a> </li>

				      <li class="nav-item  menu_nav"> <a class="nav-link" href="index.php?page=bouton.php" style=" color: white;">Examen </li>
				</ul>
				</center>
